...
<head>
    ...
    <title>Lip Color-Lakme Cosmetic</title>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
              <img src="./images/lip banner1.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="./images/lipbanner2.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="./images/lipbanner3.png" class="d-block w-100" alt="...">
          </div>
        </div>
    </div>
    <div class="row">
        <div class="col s6">
          <div class="card">
            ...
            <a href="./Purchase.php"><img src="./images/lipcolor1.jpg" class="card-img-top" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipcolor2.jpg" class="card-img-top" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipcolor3.jpg" class="card-img-top" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipstick1.jpg" class="card-img-top" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipstick2.jpg" class="card-img-top" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipstick3.jpg" class="card-img-top" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipset1.jpg" class="card-img-top3" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipset2.jpg" class="card-img-top3" alt="..."></a>
        ...
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/lipset3.jpg" class="card-img-top3" alt="..."></a>
