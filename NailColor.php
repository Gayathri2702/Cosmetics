...
<head>
    ...
    <title>Nail Color-Lakme Cosmetics</title>
...
<body>
    <nav class="navbar navbar-expand-md" id="navbar">
        ...
        <div class="navbar-collapse collapse" id="navbarCon">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="./Purchase.php"><b><i><i class="fas fa-shopping-bag">Purchase</i></i></b></a></li>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
              <img src="./images/nail banner1.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="./images/nailbanner2.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="./images/nailbanner3.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    </div>
    <div class="row">
        <div class="col s6">
          <div class="card">
            ...
            <a href="./Purchase.php"><img src="./images/nailcolor1.jpg" class="card-img-top" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailcolor2.jpg" class="card-img-top" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailcolor3.jpg" class="card-img-top" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailcrush1.jpg" class="card-img-top" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailcrush2.jpg" class="card-img-top" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailcrush3.jpg" class="card-img-top" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailset1.jpg" class="card-img-top4" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailset2.jpg" class="card-img-top4" alt="..."></a>
            </div>
          </div>
        </div>
        <div class="col s6">
          <div class="card">
            <div class="card-image">
            <a href="./Purchase.php"><img src="./images/nailset3.jpg" class="card-img-top4" alt="..."></a>
            </div>
          </div>
        </div>
    </div>
    <div class="footer container-fluid">
        ...
        <div class="row">
            ...
            <div class="col">
                <center><h5><a class="text-light" href="https://api.whatsapp.com/send?phone=919137630020&text=Send%20this%20message%f0%9f%91%89&source=&data=&app_absent="><i class="fa fa-whatsapp" aria-hidden="true"></i>Chat with us</a></h5></center>
            </div>
        </div>
    </div>
</body>
